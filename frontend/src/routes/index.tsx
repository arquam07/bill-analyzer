  ...
  return (
    <div className="lp">
      ...
      <div className="wrap">
        <section className="hero">
          <div className="hero-copy">
            ...
            <p className="lede">Photograph any receipt — mixed tax rates, multiple currencies, foreign languages. Bill Analyzer reads every line item, figures out who had what, and settles the split exactly.</p>
      ...
      <div className="factbar reveal">
        <div className="wrap">
          <div className="fact"><b>~5 sec</b><span>photo → line items</span></div>
          <div className="fact"><b>Per-item tax</b><span>any rate, extracted automatically</span></div>
          ...
          <div className="wedge reveal">
            ...
            <div className="compare">
              ...
              <div className="col us">
                ...
                <div className="cli"><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#1f7a55" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg> Per-item tax rates extracted &amp; computed exactly</div>
